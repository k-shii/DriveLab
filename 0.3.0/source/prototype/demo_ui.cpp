...
using drivelab::tui::Layout;
using drivelab::tui::makeLayout;
using drivelab::tui::drawFrame;
using drivelab::tui::printClipped;
using drivelab::tui::printRight;
using drivelab::tui::drawVerticalScrollbar;
...
int runDemoUi() {
    ...
    std::ofstream mouse_debug;
#ifndef DRIVELAB_TEST_TERMINAL
    mouse_debug.open("/tmp/drivelab-demo-mouse.log", std::ios::out | std::ios::trunc);
#endif
    bool running = true;
    bool dirty = true;
    Layout layout;
